 ...
 */
package hybris.cert.test.setup;
...
import hybris.cert.test.constants.HybriscertTestConstants;
import hybris.cert.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = HybriscertTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/hybriscerttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/hybriscerttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/hybriscerttest/import/cstickets.impex");
			...
			importImpexFile(context, "/hybriscerttest/import/csquotes.impex");
		}
	}
}
