...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hybriscertstorefront/electronics/en",
						"https://electronics.local:9002/hybriscertstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hybriscertstorefront/electronics/en",
						"https://electronics.local:9002/hybriscertstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hybriscertstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/hybriscertstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hybriscertstorefront/electronics/en",
						"https://electronics.local:9002/hybriscertstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hybriscertstorefront",
						"https://electronics.local:9002/hybriscertstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hybriscertstorefront",
						"https://electronics.local:9002/hybriscertstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/hybriscertstorefront/electronics/en",
						"https://electronics.local:9002/hybriscertstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
