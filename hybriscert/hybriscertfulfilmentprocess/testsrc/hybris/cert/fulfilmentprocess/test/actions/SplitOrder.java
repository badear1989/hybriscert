 ...
 */
package hybris.cert.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(HybriscertFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(HybriscertFulfilmentProcessConstants.PARENT_PROCESS);
