 ...
 */
package hybris.cert.fulfilmentprocess.test.jobs;
...
import hybris.cert.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = HybriscertFulfilmentProcessConstants.ORDER_PROCESS_NAME;
