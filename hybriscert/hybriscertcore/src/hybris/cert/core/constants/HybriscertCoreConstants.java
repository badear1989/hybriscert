 ...
 */
package hybris.cert.core.constants;

/**
 * Global class for all HybriscertCore constants. You can add global constants for your extension into this class.
 */
public final class HybriscertCoreConstants extends GeneratedHybriscertCoreConstants
{
	public static final String EXTENSIONNAME = "hybriscertcore";


	private HybriscertCoreConstants()
	{
		//empty
	}
