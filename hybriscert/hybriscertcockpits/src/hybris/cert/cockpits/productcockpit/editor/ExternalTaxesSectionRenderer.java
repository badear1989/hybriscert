 ...
 */
package hybris.cert.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("hybriscertcockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("hybriscertcockpits.product.externalTaxes"));
